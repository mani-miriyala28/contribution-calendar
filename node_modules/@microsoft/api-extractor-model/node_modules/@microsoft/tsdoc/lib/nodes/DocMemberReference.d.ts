import { DocNode, DocNodeKind, type IDocNodeParameters, type IDocNodeParsedParameters } from '@microsoft/api-extractor-model/node_modules/@microsoft/tsdoc/src/nodes/DocNode';
import type { DocMemberIdentifier } from '@microsoft/api-extractor-model/node_modules/@microsoft/tsdoc/src/nodes/DocMemberIdentifier';
import type { DocMemberSymbol } from '@microsoft/api-extractor-model/node_modules/@microsoft/tsdoc/src/nodes/DocMemberSymbol';
import type { DocMemberSelector } from '@microsoft/api-extractor-model/node_modules/@microsoft/tsdoc/src/nodes/DocMemberSelector';
import type { TokenSequence } from '@microsoft/api-extractor-model/node_modules/@microsoft/tsdoc/src/parser/TokenSequence';
/**
